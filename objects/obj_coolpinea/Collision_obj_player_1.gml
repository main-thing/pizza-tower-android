if (stun == 0 && obj_player.y >= y && obj_player.attacking == 0 && obj_player.state != states.tackle && obj_player.state != states.hurt && obj_player.state != states.bump && (!(vsp < 0)) && obj_player.instakillmove == 0)
{
...
if (obj_player.y < y && obj_player.state != states.hurt && obj_player.state != states.bump && obj_player.attacking == 0 && (!(vsp < 0)) && obj_player.instakillmove == 0)
{
    if (x != other.x)
    {
        hsp = (sign((x - obj_player.x)) * 3)
