...
if _levelinfo[1] != war_1 && _levelinfo[1] != characterselect && _levelinfo[1] != dragonlair_1
{
...
if _levelinfo[1] != war_1 && _levelinfo[1] != tutorial_room1 && _levelinfo[1] != characterselect && _levelinfo[1] != dragonlair_1
