function state_player_normal()
{
	...
	if(!finalmoveset){
		...
		else if ((key_slap2 or input_buffer_slap < 8) && key_up && character != "S")
		{
			state = states.punch
			image_index = 0
		...
		if(shotgunAnim){
			...
			else if (key_slap2 && input_buffer_slap > 0 && key_up && shotgunAnim == 0 && character != "S")
			{
				state = states.punch;
				input_buffer_slap = 0;
				image_index = 0;
