...
{
	snd_bodyslam = undefined//scr_soundeffect(sfx_fakepepbodyslam)
	snd_mach = undefined//scr_soundeffect(sfx_fakepepmach)
	snd_superjump = undefined//scr_soundeffect(sfx_fakepepsuperjump1, sfx_fakepepsuperjump2)
	snd_grab = undefined//scr_soundeffect(sfx_fakepepgrab)
	snd_headoff = undefined//scr_soundeffect(sfx_fakepepgrab)
	snd_flailing = undefined//scr_soundeffect(sfx_fakepepgrab)
}
...
function scr_fakepepboss_arenaintro()
{
	if (!skipintro)
	{
		...
		else if (sprite_index == spr_fakepeppino_intro2)
		{
			...
			scr_soundeffect(sfx_fakepepscream)
			image_index = 0;
			introbuffer = 130;
			with (obj_player)
			{
...
function scr_fakepepboss_walk()
{
	...
	{
		scr_soundeffect(sfx_fakepepdeform)
