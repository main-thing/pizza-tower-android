function scr_characterspr() {
	if (character == "P" && ispeppino) {
		...
		spr_HUDthunder = spr_pepinoHUDthunder
		spr_HUDknight = spr_pepinoHUDknight
		spr_HUDbombend = spr_pepinoHUDbombend
		spr_HUDscream = spr_pepinoHUDscream
		spr_HUDstun = spr_pepinoHUDstun
		spr_HUDhappy = spr_pepinoHUDhappy
		spr_HUDrolling = spr_pepinoHUDrolling
		spr_HUDmenacing = spr_pepinoHUDmenacing
		spr_HUDmach1 = spr_pepinoHUDmach1
		spr_HUDmach2 = spr_pepinoHUDmach2
		spr_HUDmach3 = spr_pepinoHUDmach3
		spr_HUDmach4 = spr_pepinoHUDmach4
		spr_HUDhurt = spr_pepinoHUDhurt
		spr_HUD3hp = spr_pepinoHUD3hp
		spr_HUD1hp = spr_pepinoHUD1hp
		spr_HUDpanic = spr_pepinoHUDpanic
		spr_HUD = spr_pepinoHUD
		hud_head_x = 125
		hud_head_y = 100
		...
		escapetimer_y = 464
		hitlag_custom = 5
		speedbarvisible = true
		usehp = false
		pizzascorespr = spr_pizzascore
		pizzascore_pepperspr = spr_pizzascore_pepper
		pizzascore_pepperonispr = spr_pizzascore_pepperoni
		pizzascore_olivespr = spr_pizzascore_olive
		pizzascore_shroomspr = spr_pizzascore_shroom
		heatmeterspr = spr_heatmeter
		heatmeter_fillspr = spr_heatmeter_fill
		heatmeter_palettespr = spr_heatmeter_palette
		speedbarspr = spr_speedbar
		speedbarmaxspr = spr_speedbarmax
		combobubblespr = spr_tv_combobubble
		combobubblefillspr = spr_tv_combobubblefill
		canbreakdance = true
		cansupertaunt = true
	}
	if (character == "N"
		...
		spr_Sjumpcancelland = spr_playerN_jetpackslide
		spr_Sjumpcancelstart = spr_playerN_jetpackstart
		spr_Sjumpcancelslide = spr_playerN_jetpackslide
		...
		_spr_tv_whitenoise = spr_tv_whitenoise
		_spr_tv_empty = spr_tv_empty
		spr_HUDthunder = spr_noiseHUD_thunder
		spr_HUDknight = spr_noiseHUD_knight
		spr_HUDbombend = spr_noiseHUD_bomb
		spr_HUDscream = spr_noiseHUD_panic
		spr_HUDstun = spr_noiseHUD_hurt
		spr_HUDhappy = spr_noiseHUD_happy
		spr_HUDrolling = spr_noiseHUD_mach2
		spr_HUDmenacing = spr_noiseHUD_menacing
		spr_HUDmach1 = spr_noiseHUD_mach1
		spr_HUDmach2 = spr_noiseHUD_mach2
		spr_HUDmach3 = spr_noiseHUD_mach3
		spr_HUDmach4 = spr_noiseHUD_mach3
		spr_HUDhurt = spr_noiseHUD_hurt
		spr_HUD3hp = spr_noiseHUD_angry
		spr_HUD1hp = spr_noiseHUD_lowhealth
		spr_HUDpanic = spr_noiseHUD_lowhealth
		spr_HUD = spr_noiseHUD_idle
		hud_head_x = 125
		hud_head_y = 100
		tauntsound = sfx_taunt
		faketv = false
	...
	if (character == "V") {
		...
		_spr_tv_exprcombo = spr_playerV_angryHUD
		_spr_tv_exprheat = spr_playerV_angryHUD
		...
		_spr_tv_tumble = spr_playerV_machHUD
		_spr_tv_whitenoise = spr_playerV_normalHUD
		_spr_tv_empty = spr_tv_empty
		spr_HUDthunder = spr_noiseHUD_thunder
		spr_HUDknight = spr_noiseHUD_knight
		spr_HUDbombend = spr_noiseHUD_bomb
		spr_HUDscream = spr_playerV_panicHUD
		spr_HUDstun = spr_playerV_hurtHUD
		spr_HUDhappy = spr_playerV_happyHUD
		spr_HUDrolling = spr_playerV_machHUD
		spr_HUDmenacing = spr_playerV_happyHUD
		spr_HUDmach1 = spr_playerV_machHUD
		spr_HUDmach2 = spr_playerV_machHUD
		spr_HUDmach3 = spr_playerV_machHUD
		spr_HUDmach4 = spr_playerV_machHUD
		spr_HUDhurt = spr_playerV_hurtHUD
		spr_HUD3hp = spr_playerV_angryHUD
		spr_HUD1hp = spr_playerV_panicHUD
		spr_HUDpanic = spr_playerV_panicHUD
		spr_HUD = spr_playerV_normalHUD
		hud_head_x = 125
		hud_head_y = 100
		tauntsound = sfx_taunt
		faketv = true
	...
	if (character == "S") {
		...
		spr_palette = spr_peppalette
		_spr_tv_barrel = spr_snickHUD
		_spr_tv_bg = spr_tv_bg
		_spr_tv_bombpep = spr_snickHUD
		_spr_tv_boxxedpep = spr_snickHUD
		_spr_tv_cheeseball = spr_snickHUD
		_spr_tv_cheesepep = spr_snickHUD
		_spr_tv_clown = spr_snickHUD
		_spr_tv_exprcollect = spr_snickHUD
		_spr_tv_exprcombo = spr_snickHUD
		_spr_tv_exprheat = spr_snickHUD
		_spr_tv_exprhurt = spr_snickHUD
		_spr_tv_exprmach3 = spr_snickHUD
		_spr_tv_exprmach4 = spr_snickHUD
		_spr_tv_exprpanic = spr_snickHUD
		_spr_tv_fireass = spr_snickHUD
		_spr_tv_firemouth = spr_snickHUD
		_spr_tv_ghost = spr_snickHUD
		_spr_tv_golf = spr_snickHUD
		_spr_tv_idle = spr_snickHUD
		_spr_tv_idleanim1 = spr_snickHUD
		_spr_tv_idleanim2 = spr_snickHUD
		_spr_tv_knight = spr_snickHUD
		_spr_tv_mort = spr_snickHUD
		_spr_tv_off = spr_null
		_spr_tv_open = spr_tv_open
		_spr_tv_rocket = spr_snickHUD
		_spr_tv_scaredjump = spr_snickHUD
		_spr_tv_shotgun = spr_snickHUD
		_spr_tv_squished = spr_snickHUD
		_spr_tv_tumble = spr_snickHUD
		_spr_tv_whitenoise = spr_snickHUD 
		_spr_tv_empty = spr_tv_empty
		spr_HUDthunder = spr_snickHUD
		spr_HUDknight = spr_snickHUD
		spr_HUDbombend = spr_snickHUD
		spr_HUDscream = spr_snickHUD
		spr_HUDstun = spr_snickHUD
		spr_HUDhappy = spr_snickHUD
		spr_HUDrolling = spr_snickHUD
		spr_HUDmenacing = spr_snickHUD
		spr_HUDmach1 = spr_snickHUD
		spr_HUDmach2 = spr_snickHUD
		spr_HUDmach3 = spr_snickHUD
		spr_HUDmach4 = spr_snickHUD
		spr_HUDhurt = spr_snickHUD
		spr_HUD3hp = spr_snickHUD
		spr_HUD1hp = spr_snickHUD
		spr_HUDpanic = spr_snickHUD
		spr_HUD = spr_snickHUD
		hud_head_x = 125
		hud_head_y = 60
		tauntsound = sfx_taunt
		faketv = true
